...
+!responder(N,Answer) : .substring( "No entend� bien tu pregunta" , Answer )  <- .send(juan,tell,question(" si ")); !responder.
+!responder.
...
+answer(Answer) : .substring( "No entend� bien tu pregunta" , Answer ) & not service(Answer,service) <- 
	.println("=============================================");
	.println;
	.println("Acabo de recibir de Juanito la contestaci�n ", Answer);
	.println;
	.println("=============================================");
	!responder(N,Answer);
	.println;
...
+answer(Answer) : not .substring( "No entend� bien tu pregunta" , Answer ) & not service(Answer,Service) <- 
	?respuesta(N);
	-+respuesta(N+1);
	+respuesta(N,Answer);
	.println("=============================================");
	.println;
	.println("Acabo de recibir de Juanito la contestaci�n ", N, " : ", Answer);
	.wait(300);
	.println;
	.println("=============================================").	
